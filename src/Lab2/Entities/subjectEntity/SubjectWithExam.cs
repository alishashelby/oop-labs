...
public class SubjectWithExam : ISubject
{
    internal SubjectWithExam(
        string name,
    ...
    {
        if (this.Author.Id != author.Id || newLabWorks.Sum(lw => lw.Points) + this.Points != 100)
        {
            return false;
        }
    ...
    {
        var newSubject = new SubjectWithExam(
            this.Name,
