...
namespace Lab4.Tests.FileDelete.UnitTests;

public class FileDeleteParserTests
{
    [Fact]
    public void ParseCorrectCommandShouldReturnSuccessAndCommand()
    {
        ...
        string[] input = ["file", "delete", "/alishashelby/src/Lab4/Lab4.csproj"];
        ...
        Assert.IsType<FileDeleteCommand>(parserResult.Result);
